...
class NoDevices extends StatefulWidget {
  static const NO_DEVICES="noDevices";
  const NoDevices({super.key});

  @override
  State<NoDevices> createState() => _NoDevicesState();
}

class _NoDevicesState extends State<NoDevices> {
  @override
            ...
            Row(
              ...
              children: <Widget>[
                ...
                builder: (ctx) => AlertDialog(
                  backgroundColor: const Color(0xff57e2c6),
