...
class DeviceOffline extends StatefulWidget {
  static const DEVICE_OFFLINE="deviceOffline";
  const DeviceOffline({super.key});

  @override
  State<DeviceOffline> createState() => _DeviceOfflineState();
}

class _DeviceOfflineState extends State<DeviceOffline> {
  @override
            ...
            Row(
              ...
              children: <Widget>[
                ...
                builder: (ctx) => AlertDialog(
                  backgroundColor: Color(0xff8167cd),
