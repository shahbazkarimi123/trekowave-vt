...
class StoppedVehicles extends StatefulWidget {
  static const STOPPED_VEHICLES = 'stoppedVehicles';
  const StoppedVehicles({super.key});

  @override
  State<StoppedVehicles> createState() => _StoppedVehiclesState();
}

class _StoppedVehiclesState extends State<StoppedVehicles> {
  @override
            ...
            Row(
              ...
              children: <Widget>[
                ...
                builder: (ctx) => AlertDialog(
                  backgroundColor: Color(0xfffa8e4a),
                  title: Text(name,style: TextStyle(color: Colors.white),),
                  content: Text(dialogContaint,style: TextStyle(color: Colors.white,),),
                  actions: <Widget>[
