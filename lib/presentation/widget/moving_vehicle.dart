...
class MovingVehicle extends StatefulWidget {
  static const MOVING_VEHICLE="movingVehicle";
  const MovingVehicle({super.key});

  @override
  State<MovingVehicle> createState() => _MovingVehicleState();
}

class _MovingVehicleState extends State<MovingVehicle> {
  @override
            ...
            Row(
              ...
              children: <Widget>[
                ...
                builder: (ctx) => AlertDialog(
                  backgroundColor: Color(0xff00c5e2),
