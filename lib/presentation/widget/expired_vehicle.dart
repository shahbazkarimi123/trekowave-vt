...
class ExpiredVehicle extends StatefulWidget {
  static const EXPIRED_VEHICLE = "expiredVehicle";
  const ExpiredVehicle({super.key});

  @override
  State<ExpiredVehicle> createState() => _ExpiredVehicleState();
}

class _ExpiredVehicleState extends State<ExpiredVehicle> {
  @override
            ...
            Row(
              ...
              children: <Widget>[
                ...
                builder: (ctx) => AlertDialog(
                  backgroundColor: Color(0xff1c7b84),
